...
def main():
    ...
    transform = transforms.Compose([
        transforms.Resize((227, 227)),  # 将图像大小调整为224x224，这是AlexNet的要求
    ...
    model_save_path = 'yanzhi/models/model_alexnet.pth'  # 修改保存路径以反映模型变化
    
    # 模型训练
    train_model(model, train_loader, learning_rate, num_epochs, device, model_save_path, "alexnet")

    # 模型测试
    test_model(model, test_loader, device, "alexnet")
